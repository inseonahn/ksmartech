Kotlin 공식 문서의 <a href="https://kotlinlang.org/docs/coding-conventions.html/" target="_blank">Coding Convention</a>과 <a href="https://kotlinlang.org/docs/coding-conventions.html/" target="_blank">Android Kotlin Guides</a>을 한글로 번역하고 필요한 개념을 함께 정리한 내용입니다.
